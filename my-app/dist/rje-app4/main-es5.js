...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_div_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("getUsersEvent", function AppComponent_div_3_Template_app_display_board_getUsersEvent_28_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
      ...
      _createClass(AppComponent, [{
        ...
        value: function getAllUsers() {
          ...
          this.appService.getUsers().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.destroy$)).subscribe(function (users) {
            _this2.users = users;
            _global_values__WEBPACK_IMPORTED_MODULE_4__["GlobalValues"].currentId = _this2.users.length; //alert("total users:" + GlobalValues.currentId + " of " + this.users.length);
          });
        }
      }, {
        key: "ngOnDestroy",
    ...
    function () {
      ...
      _createClass(AppService, [{
        ...
        value: function deleteUser(id) {
          ...
          alert("param: " + param.toString()); //var del =  this.http.request();
  ...
  function srcAppEdituserComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function EditUserComponent_app_users_28_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function () {
      ...
      _createClass(NewUserComponent, [{
        ...
        value: function getAllUsers() {
          ...
          this.appService.getUsers().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.destroy$)).subscribe(function (users) {
            _this6.users = users;
            _global_values__WEBPACK_IMPORTED_MODULE_4__["GlobalValues"].currentId = _this6.users.length; //alert("total users:" + GlobalValues.currentId + " of " + this.users.length);
          });
        }
      }, {
        key: "ngOnDestroy",
  ...
  function srcAppUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function UsersComponent_div_3_tr_20_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UsersComponent_div_3_tr_20_Template_button_click_3_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UsersComponent_div_3_tr_20_Template_button_click_6_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);
    ...
    function () {
      ...
      _createClass(UsersComponent, [{
        ...
        value: function editUser(user) {
          ...
          this.showList = false; //alert("You are here: " + user.id);
        ...
        value: function deleteUser(user) {
          ...
          if (confirm("Are you sure you want to delete " + user.firstName + " " + user.lastName + " ?")) {
            this.appService.deleteUser(user.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.destroy$)).subscribe(function (data) {
              console.log('message::::', data); //this.userCount = this.userCount;
        ...
        value: function getAllUsers() {
          ...
          this.appService.getUsers().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.destroy$)).subscribe(function (users) {
            _this7.users = users;
            _global_values__WEBPACK_IMPORTED_MODULE_3__["GlobalValues"].currentId = _this7.users.length; //alert("total users:" + GlobalValues.currentId + " of " + this.users.length);
